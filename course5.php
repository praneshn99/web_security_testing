			...
			<div id="header">
				...
				<div id="menu">
					<ul>
						...
						<li><a href="course2.php">Course 2</a></li>
						<li><a href="course3.php">Course 3</a></li>
						<li><a href="course4.php">Course 4</a></li>
						<li class="last"><a href="course5.php" class="active">Course 5</a></li>
					</ul>
					<br class="clearfix" />
				</div>
			</div>
			...
			<div id="page">
				<div id="content">
                    ...
                    <main>
                          ...
                          <br/>
                    <div class="post"></div>
					<iframe src="comment_c5.php" width="100%" height="80%"></iframe>                  </div>
</div>
			</div>
		</div>
		<div id="footer">
