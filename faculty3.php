...
<div id="header" class="container">
	...
	<div id="menu">
		<ul>
			...
			<li><a href="faculty2.php">Faculty 2</a></li>
			<li><a href="faculty3.php" id="active">Faculty 3</a></li>
		</ul>
	</div>
</div>
<div id="wrapper" class="container">
	<div id="page">
        <div id="content"> <img src="images/try.jpg " width="600" height="250" alt="" style="border-radius: 20px"/>
            <br/><br/>
			<h2>Overview</h2>
			...
			<h2>Write a review</h2><br/>
                    <iframe src="comment_f3.php" width="100%" height="80%"></iframe>
		</div>
		<div id="sidebar">
			<div id="sbox1">
				<h2>History</h2>
